...
<%
  ...
  //int sid1= Integer.valueOf((String)request.getParameter("sid"));
	...
	try
	{
		...
		sql = "select * from teaches JOIN section on teaches.course_id=section.course_id JOIN course on teaches.course_id=course.course_id JOIN time_slot on time_slot.time_slot_id=section.time_slot_id where teaches.teacher_id='"+tid1+"' ";

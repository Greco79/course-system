...
<body style="background-color: #353C47">
    ...
    studentpass=(String)request.getParameter("password");
    studentmail=(String)request.getParameter("mail");
    //TODO
    ...
    //String sql="select user_name from user where user_id='"+user_id+"'";
       ...
       if(studentname!=null){
            String sql="update user set user_name='"+studentname+"' , password='"+studentpass+"',mail='"+studentmail+"' where user_id='"+user_id+"'"; 
        ...
        result=stat.executeUpdate(sql);
         ...
         if(result!=0){
       String script = "<script>alert('修改成功');location.href='student.jsp'</script>";
        response.getWriter().println(script);
          }else{
              String script = "<script>alert('修改失败，请稍后重试');location.href='studentself.jsp'</script>";
        response.getWriter().println(script);
          }
        }
            ...
            <div class="header-content clearfix">
                <div class="header-bar-position" style="display: block;position: relative">
                    ...
                    <div class="user-entry" style="display: inline-block;">
                        <%
                            if(sid>=0){%>
                                <a class="growth-entry user-up" ><%=sid %></a>
...
<div class="shop2" style="background-color: #6A6D74;height:500px;width:600px;padding-top:100px;margin-left:300px;margin-top:0;">
  <div class="name1" ><a style="color:black">个人信息</a></div>
    <div class="name2"> 
      ...
      <div class="output1" >
      <form action="../student/studentself.jsp" method="POST">
        <a >修改用户名</a>

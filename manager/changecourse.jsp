...
<body style="background-color: #353C47">
    ...
    String sql="select * from course where course_id='"+user_id+"'";
        //3.获取Connection对象
        ...
        while(rs.next()){
            ...
            ccredit+=rs.getString(3);
            ctest+=rs.getString(4);
            cdep+=rs.getString(5);
        }
  ...
  <div class="name1" ><a style="color:black">个人信息</a></div>
    <div class="name2"> 
      ...
      <form action="updatecourse.jsp" method="POST">
        <input type="hidden" name="coid" value="<%=user_id%>">
        <a >修改ID</a>
        <input type="text" name="cid" value="" placeholder="<%=cid%>">
        
        <a >修改课程名称(英文)</a>
        <input type="text" name="cname" value="" placeholder="<%=cname%>">
        
        <a >学分(数字）</a>
        <input type="text" name="ccredit" value="" placeholder="<%=ccredit%>">

        <a >修改考试方式(英文)</a>
        <input type="text" name="ctest" value="" placeholder="<%=ctest%>">
        
        <a >修改学院(英文)</a>
        <input type="text" name="cdep" value="" placeholder="<%=cdep%>">

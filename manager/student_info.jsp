            ...
            <div class="header-content clearfix">
                ...
                <div class="header-bar-nav">
                    <ul class="header-nav-first">
                      <li ><a href="http://localhost/shujuku/manager/course_info.jsp" >课程信息</a></li>
                      <li><a  href="http://localhost/shujuku/manager/student_info.jsp">学生信息</a></li>
                      <li><a href="http://localhost/shujuku/manager/teacher_info.jsp" >教师信息</a></li>
                      <li><a href="http://localhost/shujuku/manager/managerself.jsp">个人信息</a></li>
                    </ul>
                </div>  
            </div>
        </div>
     ...
     user_id1=rs.getInt(10);
        ...
        <tr>
            ...
            <td class="buy-table-top"><%
                ...
                %></td>
            <td class="buy-table-top"><%=rs.getDate(4) %></td>
            <td class="buy-table-top"><%=rs.getString(5) %></td>
            <td class="buy-table-top"><%=rs.getString(6) %></td>
            <td class="buy-table-top"><%=rs.getInt(7) %></td>
            <td class="buy-table-top"><%=rs.getInt(8) %></td>
            <td class="buy-table-top"><%=rs.getString(9) %></td>
            <th class="buy-table-top">
              <form action="changestudent.jsp">
...
<div class="skin-box-hd bzb">
            <h3>
               <form action="addstudent.jsp">
                <input type="hidden" name="id1" value="<%=id%>">
                  <input type="submit" value="添加学生" name="submit">
                </form>
            </h3>
        </div>
             </table>
